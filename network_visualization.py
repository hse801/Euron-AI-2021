...
Original file is located at
    https://colab.research.google.com/drive/1d4MncqRHMUAdNahOAQd4x3_bfMAAkZqx
"""
...
**Your Answer:** 
Saliency map은 (H, W)의 dimension을 갖고, 이미지는 RGB채널을 갖기 때문에 (H, W, 3)의 dimension을 갖는다. 그러므로 사용할 수 없을 것이다. (grayscale 이미지라면 가능할 것이다)
