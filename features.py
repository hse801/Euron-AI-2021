...
Original file is located at
    https://colab.research.google.com/drive/1JdJxKu-PNtM1mBvGJJRo-YYJLTZghhvr
"""
...
SVM classifier은 이미지의 texture이나 색과 같은 정보들을 인풋으로 사용한다. 따라서 잘못 분류된 이미지들은 거의 비슷한 texture나 전체적으로 비슷한 색감을 보인다.
